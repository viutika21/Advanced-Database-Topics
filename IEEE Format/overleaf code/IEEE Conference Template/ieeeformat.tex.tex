...
\fancyhead[R]{Shafaq Khan et al.}
% Custom footer with copyright notice
\renewcommand{\footrulewidth}{0pt} % Optional: Add a footer rule
\fancyfoot[R]{Page \thepage \hspace{1pt}}
% \fancyfoot[C]{\small 2023 Summer Semester Advanced Database Topics, All rights reserved.}
...
\author{\IEEEauthorblockN{Dr. Shafaq Khan*}
\IEEEauthorblockA{\textit{School of Computer Science} \\
\textit{University of Windsor, Ontario,Canada}\\
}
\and
\IEEEauthorblockN{Viutika Rathod}
\IEEEauthorblockA{\textit{School of Computer Science} \\
\textit{University of Windsor, Ontario,Canada}\\
}
\and
\IEEEauthorblockN{Abhirup Ranjan}
\IEEEauthorblockA{\textit{School of Computer Science} \\
\textit{University of Windsor, Ontario,Canada}\\
}
\and
\IEEEauthorblockN{Anika Anjum Una}
\IEEEauthorblockA{\textit{School of Computer Science} \\
\textit{University of Windsor, Ontario,Canada}\\
}
\and
\IEEEauthorblockN{Neel Manish Pandya}
\IEEEauthorblockA{\textit{School of Computer Science} \\
\textit{University of Windsor, Ontario,Canada}\\
}
}
