...
\setlength{\columnsep}{0.8cm} % Set the column spacing
\setlength{\columnwidth}{7.5cm} % Set the column width
...
\author{\authorname{Shafaq Khan, Viutika Rathod, Abhirup Ranjan, Anika Anjum Una and Neel Manish Pandya}
...
The Indigenous communities in Canada experience significantly higher dropout rates compared to non-Indigenous communities in this part of the world, attributed to a range of factors such as historical and inter-generational impacts, financial inequities, social marginalization, lack of support systems, and geographic barriers \cite{GovtOfOntario17}. These factors restrict access to quality education for Indigenous students, resulting in lower educational achievements compared to the general population of Canada \cite{CFSOntario21}.
